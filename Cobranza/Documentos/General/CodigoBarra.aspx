<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CodigoBarra.aspx.cs" Inherits="CobranzaALC.Cobranza.Documentos.General.CodigoBarra1" %>
            ...
            <table cellpadding="0" cellspacing="0" style="width: 100%; border: 2px solid #000;">
                <tr>
                    ...
                    <td style="width: 70%; padding: 10px 0 10px 10px;" valign="top">
                        <asp:Image ID="imgCodigoQr" runat="server" Width="50px" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%; padding: 10px 0 10px 0;" align="center">
