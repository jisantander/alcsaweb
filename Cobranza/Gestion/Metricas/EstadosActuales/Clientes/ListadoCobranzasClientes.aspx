<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListadoCobranzasClientes.aspx.cs" Inherits="CobranzaALC.Cobranza.Gestion.Metricas.EstadosActuales.Clientes.ListadoCobranzasClientes" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#btnVolver').click(function () {
                window.location = 'ListadoClientes.aspx';
            });
        });
    </script>
</head>
    ...
    <form id="form1" runat="server">
        <div>
            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; min-width: 700px;">
                <tr>
                    <td class="barra-titulo" colspan="4">Cobranzas Cliente:
                ...
                <tr>
                    <td align="left" colspan="4">
                        <asp:GridView ID="gvDetalle" runat="server"
                            ...
                            <Columns>
                                <asp:BoundField HeaderText="N° Operación" DataField="NumeroOperacion">
                                </asp:BoundField>
        ...
        <asp:HiddenField ID="hdfRutCliente" runat="server" />
