<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DigiConsulta.aspx.cs" Inherits="CobranzaALC.Cobranza.Digitalizar.DigiConsulta" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ValidarBuscar() {
            if (document.all("txtRut").value == "" && document.all("txtFolio").value == "") {
    ...
    <form runat="server" id="Formulario">
        <table cellspacing="0" cellpadding="0" width="750" border="0">
            <tbody>
                ...
                <tr>
                    <td height="50" align="right" class="textos">
                                ...
                                <tr>
                                    <td height="114" width="100%" valign="top">
                                        ...
                                        <table bordercolor="#c8e3f9" cellspacing="0" cellpadding="0"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td align="left" bgcolor="#eeeeee"><b>&nbsp;DOCUMENTOS DIGITALIZADOS</b></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    ...
                                                    <table border="0" width="100%" bgcolor="#e6ecf2" border="0">
                                                        ...
                                                        <tr>
                                                            <td align="right" class="style2">Folio :</td>
                                                            <td align="left" class="style6">
