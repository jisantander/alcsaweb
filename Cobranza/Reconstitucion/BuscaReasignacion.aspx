<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuscaReasignacion.aspx.cs" Inherits="CobranzaALC.Cobranza.Reconstitucion.BuscaReasignacion" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function VentanaModalEdit(OT, Responsable) {
            var Url = "popReasignar.aspx?OT=" + OT + "&Responsable=" + Responsable;
...
<body>
    <form runat="server" id="Formulario">
        <table cellspacing="0" cellpadding="0" width="633" border="0">
            <tbody>
                <tr>
                    <td height="50" valign="top" bgcolor="#336699" class="titulo" style="text-align:center" xbackground="../../images/banner2.jpg">
                        SISTEMA DE RECONSTITUCIONES
                    </td>
                </tr>
                <tr>
                                ...
                                <tr>
                                    <td height="114" width="100%" valign="top">
                                        <table bordercolor="#c8e3f9" cellspacing="0" cellpadding="0"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td align="left" bgcolor="#eeeeee"><b>&nbsp;REASIGNAR OT</b></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    <asp:GridView ID="Grilla" runat="server"
                                                        ...
                                                        GridLines="None">
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Reasignar OT" HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:ImageButton ID="btnEditar" runat="server" ImageUrl="../../images/b_editar.gif" Width="18px" Height="18px" ToolTip="Reasignar OT" CommandName="Editar" CssClass='<%# Bind("OT") %>' OnClientClick="VentanaModalEdit($(this).attr('class'));" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="Responsable" HeaderStyle-HorizontalAlign="Left">
                                                                ...
                                                                <ItemStyle Wrap="false"></ItemStyle>
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblNombre7766" runat="server" Text='<%# Bind("user_responsable") %>' SortExpression="Descripcion" SortDirection="ASC"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="IdContratista" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblOT" runat="server" Text='<%# Bind("OT") %>' SortExpression="lblIdAccion"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
