<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CargaMasiva.aspx.cs" Inherits="CobranzaALC.Cobranza.Reconstitucion.CargaMasiva" %>
...
<body  >
  ...
  <TR> 
    <TD width="633" height=50 valign="top" bgcolor="#336699"  xbackground="../../images/banner2.jpg"> 
      <TABLE align=right border=0 style="width: 363px">
        <TBODY> 
        <TR> 
  ...
  <TR> 
   ...
   <asp:ScriptManager ID="ScriptManager1" runat="server">
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <asp:TextBox ID="txtRemesa" runat="server"  onKeyPress="return acceptNum(event)"
                                style="WIDTH: 50px; margin-left: 0px;" Width="107px" ></asp:TextBox>
      ...
      <asp:HiddenField ID="hddRemesa" runat="server" />
      <asp:HiddenField ID="hddFentrega" runat="server" />
      <asp:HiddenField ID="hddFactual" runat="server" />
