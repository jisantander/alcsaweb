<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LisExhortos.aspx.cs" Inherits="CobranzaALC.Cobranza.listados.LisExhortos" %>
          ...
          <TR> 
            ...
            <!-- Zona de Titulo -->
              ...
              <TABLE borderColor=#c8e3f9 cellSpacing=0 cellPadding=0 
                ...
                <TBODY> 
                <TR> 
                  <TD align="left"  bgColor=#eeeeee><b>&nbsp;LISTADO EXHORTOS</b></TD>
                </TR>
                </TBODY> 
              </TABLE>
                         ...
                         <!-- Inicio Grilla -->
                           <asp:GridView ID="Grilla" runat="server" 
                            ...
                            <asp:TemplateField HeaderText="Acción"  >
                              ...
                              <asp:TemplateField HeaderText="Id. Exhorto">
                                <HeaderStyle Wrap="true"></HeaderStyle>
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblCodigo" runat="server" Text='<%# Bind("id_exhorto") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
                             ...
                             <ItemStyle Wrap="false" ></ItemStyle>
                              <ItemTemplate>
                               <asp:Label ID="lblNombre" runat="server" Text='<%# Bind("id_juicios") %>' SortExpression = "Descripcion" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
                             ...
                             <ItemStyle Wrap="false" ></ItemStyle>
                              <ItemTemplate>
                               <asp:Label ID="lblNombre" runat="server" Text='<%# Bind("rol_exhorto") %>' SortExpression = "Descripcion" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
