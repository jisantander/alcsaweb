<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EscritoPrejudicial.aspx.cs" Inherits="CobranzaALC.Cobranza.Escritos.EscritoPrejudicial" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Ir(pagina, estado) {
            if (trim(estado) == 'A') {
                var deudor = document.all("hiddeDeudor").value;
                var direccion = document.all("hiddenDireccion").value;
                var comuna = document.all("hiddenComuna").value;

                pagina = pagina + '&deudor=' + deudor + '&direccion=' + direccion + '&comuna=' + comuna;
                popup(pagina, '800', '650');
            }
        ...
        function ValidarBuscar() {
            ...
            if (trim(document.all("txtRut").value) == "") // && document.all("txtNroOperacion").value == "")
            {
...
<body>
    ...
    <form runat="server" id="Formulario">
                                ...
                                <tr>
                                    <td height="114" width="100%" valign="top">
                                        ...
                                        <table bordercolor="#c8e3f9" cellspacing="0" cellpadding="0"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td align="left" bgcolor="#eeeeee"><b>&nbsp;ESCRITO PRE-JUDICIAL</b></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    ...
                                                    <table border="0" width="100%" bgcolor="#e6ecf2" border="0">
                                                        ...
                                                        <tr>
                                                            <td align="right" class="style2">Direcciones:</td>
                                                            <td align="left" class="style4" colspan="2">

                                                                <asp:DropDownList ID="domicilios" runat="server" AutoPostBack="true"
                                                                    Style="WIDTH: 350px; margin-left: 0px;" OnSelectedIndexChanged="domicilios_SelectedIndexChanged">
                                                                </asp:DropDownList>
                                                            </td>
                                                    ...
                                                    <asp:GridView ID="Grilla" runat="server"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Acción">
                                                                <ItemTemplate>
                                                                    <a href="#" onclick="javascript:Ir('ImprimeEscritoPrejudicial.aspx?Codigo=<%# Eval("id_cobranza") %>&cliente=<%# Eval("cliente") %>','<%# Eval("tipo") %>');">
                                                                        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/action_print.gif" ToolTip="Imprimir escrito" /></a>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="Estado">
                                                                ...
                                                                <ItemStyle Wrap="false"></ItemStyle>
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblNombre" runat="server" Text='<%# Bind("tipo") %>' SortExpression="Descripcion" SortDirection="ASC"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
        ...
        <asp:HiddenField ID="hiddeDeudor" runat="server" />
        <asp:HiddenField ID="hiddenDireccion" runat="server" />
        <asp:HiddenField ID="hiddenComuna" runat="server" />
