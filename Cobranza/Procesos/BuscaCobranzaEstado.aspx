<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuscaCobranzaEstado.aspx.cs" Inherits="CobranzaALC.Cobranza.Procesos.BuscaCobranzaEstado" %>
                                                    ...
                                                    <asp:GridView ID="Grilla" runat="server"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Acción">
                                                                <ItemTemplate>
                                                                    <a href="#" onclick="javascript:Ir('juicioestado.aspx?Codigo=<%# Eval("id_cobranza") %>','<%# Eval("estado") %>');">
