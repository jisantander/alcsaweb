    ...
    <form runat="server" id="Formulario">
        <table border="0" class="auto-style3">
            ...
            <tr>
                ...
                <td align="left"  colspan="3" >
                    <asp:TextBox ID="txtDestinatarios" text-aling="justify" runat="server" Width="98%" TextMode="MultiLine" text="mnarvaez@alcsa.cl, gigatica@alcsa.cl, pcarreno@alcsa.cl, pvila@alcsa.cl, mjgonza@alcsa.cl, msobarzo@alcsa.cl, tlmartine@alcsa.cl, yrojas@alcsa.cl, jorgeleiva@tie.cl, receptorapcastro@gmail.com, receptordelcampo@gmail.com" CssClass="auto-style4" Height="120px"></asp:TextBox>
                    <br />
