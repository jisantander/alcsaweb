<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MostrarActividades.aspx.cs" Inherits="CobranzaALC.Cobranza.Procesos.MostrarActividades" %>
          ...
          <TR> 
            ...
            <!-- Zona de Titulo -->
              ...
              <TABLE borderColor=#c8e3f9 cellSpacing=0 cellPadding=0 
                ...
                <TBODY> 
                <TR> 
                  <TD align="left"  bgColor=#eeeeee><b>&nbsp;ACTIVIDADES INGRESADAS</b></TD>
                </TR>
                </TBODY> 
              </TABLE>
              ...
              <table border="0" width="100%" bgColor=#e6ecf2 border=0>
                    <tr>
                     ...
                     <tr>
                      ...
                      <tr>
                        <td align="left" class="style2" >&nbsp;&nbsp;&nbsp;Tribunal :</td>
                        <td  align="left" class="style7" >
                            <asp:TextBox ID="txtTribunal" runat="server" 
                                style="WIDTH: 260px; margin-left: 0px; " Width="138px" ReadOnly="True"></asp:TextBox>
                               
                        </td>
                        <td align="left" class="style8" >&nbsp;&nbsp;&nbsp;Rol-Rit :</td>
                        <td  align="left" class="style6" >
                  ...
                  <!-- Inicio Grilla -->
                           <asp:GridView ID="Grilla" runat="server" 
                            ...
                            <Columns>
                             ...
                             <asp:TemplateField HeaderText="ID Tramite">
                                <HeaderStyle Wrap="true"></HeaderStyle>
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblCodigo" runat="server" Text='<%# Bind("corr") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
                              ...
                              <asp:TemplateField HeaderText="Trámite">
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblCodigo" runat="server" Text='<%# Bind("descripcion") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
                             ...
                             <asp:TemplateField    HeaderText="Fecha Prox. Gestión">
                             <HeaderStyle Wrap="true"></HeaderStyle>
                             <ItemStyle Wrap="false" ></ItemStyle>
                              <ItemTemplate>
                               <asp:Label ID="lblNombre" runat="server" Text='<%# Bind("fproxgestion") %>' SortExpression = "Descripcion" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
                             
                             <asp:TemplateField    HeaderText="Sub Trámite">
                             <HeaderStyle Wrap="true"></HeaderStyle>
                             <ItemStyle Wrap="false" ></ItemStyle>
                              <ItemTemplate>
                              ...
                              <asp:TemplateField    HeaderText="Fecha Sub Trámite">
                             <HeaderStyle Wrap="true"></HeaderStyle>
                             <ItemStyle Wrap="false" ></ItemStyle>
                              <ItemTemplate>
                               <asp:Label ID="lblNombre" runat="server" Text='<%# Evaluar(Eval("fsubtramite")) %>' SortExpression = "Descripcion" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
                             ...
                             <ItemStyle Wrap="false" ></ItemStyle>
                              <ItemTemplate>
                               <asp:Label ID="lblNombre" runat="server" Text='<%# Evaluar(Eval("observacion")) %>' SortExpression = "Descripcion" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
