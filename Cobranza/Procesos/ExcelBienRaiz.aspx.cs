namespace CobranzaALC.Cobranza.Procesos
{
    ...
    public partial class ExcelBienRaiz : Page
    {
        ...
        private void Excel()
        {
            ...
            base.Response.AddHeader("Content-Disposition", "attachment;filename=ExcelBienRaiz.xls");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.Page.IsPostBack)
            {
                ...
                table = (DataTable) this.Session["Excel_Bie_Raiz"];
