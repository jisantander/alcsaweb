<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuscaCobranzaExhortos.aspx.cs" Inherits="CobranzaALC.Cobranza.Procesos.BuscaCobranzaExhortos" %>
...
<head id="Head1" runat="server">
    ...
    <link href="../../css/start/jquery-ui-1.10.3.custom.min.css" rel="stylesheet" type="text/css" />
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Ir(pagina, estado) {
            if (trim(estado) == 'A' || trim(estado) == 'R')
...
<body>
    ...
    <form runat="server" id="Formulario">
                                ...
                                <tr>
                                    <td height="114" width="100%" valign="top">
                                        ...
                                        <table bordercolor="#c8e3f9" cellspacing="0" cellpadding="0"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td align="left" bgcolor="#eeeeee"><b>&nbsp;BUSCAR COBRANZA</b></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                                    ...
                                                    <asp:GridView ID="Grilla" runat="server"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Acción">
                                                                <ItemTemplate>
                                                                    <a href="#" onclick="javascript:Ir('Exhorto.aspx?Codigo=<%# Eval("id_juicios") %>','<%# Eval("tipo") %>');">
                                                                        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/b_editar.gif" ToolTip="Agregar exhorto" /></a>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="N° de Operación">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCodigo" runat="server" Text='<%# Bind("operacion") %>' SortExpression="Codigo" SortDirection="ASC"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
        ...
        <asp:HiddenField ID="hdfMostrarMensaje" runat="server" Value="0" EnableViewState="false" ClientIDMode="Static" />
        <asp:HiddenField ID="hdfIdDocumento" runat="server" Value="0" EnableViewState="false" ClientIDMode="Static" />

        <div id="divMensaje" title="Cobranza">
            <p>El exhorto se guardó correctamente.</p>
