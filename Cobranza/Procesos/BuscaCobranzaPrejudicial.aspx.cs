namespace CobranzaALC.Cobranza.Procesos
{
    ...
    public partial class BuscaCobranzaPrejudicial : Page
    {
        ...
        {
            this.Grilla.DataSource = ConsultasEspecificas.ConsultaCobranzaPrejudicial(this.txtRut.Text, this.txtNroOperacion.Text);
