<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExceDocu_estandard4.aspx.cs" Inherits="CobranzaALC.Cobranza.Procesos.ExceDocu_estandard4" %>
...
<body>
    ...
    <asp:GridView ID="Grilla" runat="server" 
           ...
           <asp:TemplateField HeaderText="Delito">
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblCweweweweodigo" runat="server" Text='<%# Bind("delito") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
