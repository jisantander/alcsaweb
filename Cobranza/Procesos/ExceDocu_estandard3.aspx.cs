namespace CobranzaALC.Cobranza.Procesos
{
    ...
    public partial class ExceDocu_estandard3 : Page
    {
        ...
        private void Excel()
        {
            ...
            base.Response.AddHeader("Content-Disposition", "attachment;filename=ExcelDocuEstandard3.xls");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.Page.IsPostBack)
            {
                ...
                table = (DataTable) this.Session["docu_juicio_estandard_3"];
