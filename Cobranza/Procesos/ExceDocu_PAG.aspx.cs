namespace CobranzaALC.Cobranza.Procesos
{
    ...
    public partial class ExceDocu_PAG : Page
    {
        ...
        private void Excel()
        {
            ...
            base.Response.AddHeader("Content-Disposition", "attachment;filename=ExcelDoc_pagare.xls");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.Page.IsPostBack)
            {
                ...
                table = (DataTable) this.Session["doc_pag_are"];
