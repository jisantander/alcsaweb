namespace CobranzaALC.Cobranza.Procesos
{
    ...
    public partial class ExceDocu_jui : Page
    {
        ...
        private void Excel()
        {
            ...
            base.Response.AddHeader("Content-Disposition", "attachment;filename=ExcelDocuJuicio.xls");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.Page.IsPostBack)
            {
                ...
                table = (DataTable) this.Session["docu_jui_c_io"];
