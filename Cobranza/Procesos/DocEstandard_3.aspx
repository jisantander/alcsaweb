<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocEstandard_3.aspx.cs" Inherits="CobranzaALC.Cobranza.Procesos.DocEstandard_3" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            AsignarAutocompletar('txtrutrepre1', 'txtrepresentante1', 'txtDireccionrepresentante', '');
    ...
    <form runat="server" id="Formulario">
        ...
        <div id="divCuerpo">
            <table cellspacing="0" cellpadding="0" border="0" style="width: 100%;">
                <tbody>
                    <tr>
                        <td class="barra-sub-titulo" colspan="4">DOCUMENTO ESTÁNDARD 3
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 30%" class="letra">
                            ...
                            <asp:TextBox ID="txtrutrepre1" runat="server"></asp:TextBox>
                        </td>
                        <td style="width: 20%" class="letra">Nombre</td>
                        <td style="width: 30%" class="letra">

                            <asp:TextBox ID="txtrepresentante1" runat="server" Width="95%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 30%" class="letra">
                            <asp:TextBox ID="txtprofesionuoficio" runat="server" Width="95%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="width: 20%" class="letra">FechaTermino Relación Laboral</td>
                        <td style="width: 30%" class="letra">
                            <asp:TextBox ID="txtFechaTerminoRelacionLaboral" runat="server" CssClass="control-calendario"></asp:TextBox>
                        </td>
                        <td style="width: 20%" class="letra">Monto Remuneración</td>
                        <td style="width: 30%" class="letra">
                            <asp:TextBox ID="txtMontoRemuneracion" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 20%" class="letra">Fecha Inicio Relación Laboral</td>
                        <td style="width: 30%" class="letra">
                            <asp:TextBox ID="txtFechaInicioRelacionLaboral" runat="server" CssClass="control-calendario"></asp:TextBox>
                        </td>
                        <td style="width: 20%" class="letra">Cargo</td>
                        <td style="width: 30%" class="letra">
                            <asp:TextBox ID="txtCargo" runat="server" Width="95%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="letra" colspan="3">
                            <asp:TextBox ID="txtRelaciondeloshechos" runat="server"
                                ...
                                Rows="5" Height="65px"></asp:TextBox>
                    ...
                    <tr>
                        <td class="barra-sub-titulo" align="right" colspan="4"></td>
                    </tr>
                    <tr>
                        <td class="letra" align="center" colspan="4"><font size="2">Estado Nº 359 Piso 13, Santiago - Chile | Teléfonos : 633 3115 - 633 3483 </font>

                        </td>
                    </tr>

                    <tr>
                        <td colspan="4">&nbsp;<asp:HiddenField ID="hdfIdDocumento3" runat="server" Value="0" />
