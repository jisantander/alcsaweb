<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuscaDocuPrejudicial.aspx.cs" Inherits="CobranzaALC.Cobranza.Procesos.BuscaDocuPrejudicial" %>
                  ...
                  <!-- Inicio Grilla -->
                           <asp:GridView ID="Grilla" runat="server" 
                            ...
                            <asp:TemplateField HeaderText="Acción"  >
                              <ItemTemplate>
                               <a href="#" onclick="javascript:Ir('Cuotacolegio.aspx?Codigo=<%# Eval("id_cobranza") %>&proceso=I','<%# Eval("estado") %>');" ><asp:Image ID="Image1" runat="server" ImageUrl="~/images/b_editar.gif" ToolTip="Agregar Documento Pre-Judicial"  /></a> 
                              </ItemTemplate>
                             </asp:TemplateField>
