namespace CobranzaALC.Cobranza.Procesos
{
    ...
    public partial class ActividadesDocuMutuo : Page
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string str5 = "ActividadesDocuMutuo.aspx?Codigo=" + this.hiddidjuicio.Value.ToString() + "&idCobranza=" + this.hiddidCobranza.Value.ToString() + "&termino=" + str4;
        ...
        private void ComboSubTramite()
        {
            ...
            this.subtramite.DataSource = Consulta.ComboSubTramiteGENERAL("MUTUO");
        ...
        {
            DataTable table = null;
            table = Consulta.GENMostrartramiteProximaGestion(indice, "MUTUO");
            try
            {
        ...
        {
            DataTable table = null;
            table = Consulta.GENtramite("MUTUO");
