namespace CobranzaALC.Cobranza.Procesos
{
    ...
    public partial class MostrarDocuEstandard1Consula : Page
    {
        ...
        private void CargaGrilla(string idcobranza)
        {
            ...
            table = ConsultasEspecificas.MostrarDocuJuicioEstandard_1(idcobranza);
            this.Session["docu_juicio_estandard_1"] = table;
