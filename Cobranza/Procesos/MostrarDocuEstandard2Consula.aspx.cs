namespace CobranzaALC.Cobranza.Procesos
{
    ...
    public partial class MostrarDocuEstandard2Consula : Page
    {
        ...
        private void CargaGrilla(string idcobranza)
        {
            ...
            table = ConsultasEspecificas.MostrarDocuJuicioEstandard_2(idcobranza);
            this.Session["docu_juicio_estandard_2"] = table;
