namespace CobranzaALC.Cobranza.ConsultaEspecial
{
    ...
    public partial class BuscaConsultaJuicio : Page
    {
        ...
        {
            this.Grilla.DataSource = ConsultasEspecificas.ConsultaCobranzaConsulta(this.txtRut.Text, this.txtNroOperacion.Text);
