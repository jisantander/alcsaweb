<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Prueba.aspx.cs" Inherits="CobranzaALC.Cobranza.Consultas.Prueba" %>
          ...
          <TR> 
            ...
            <!-- Zona de Titulo -->
              ...
              <TABLE borderColor=#c8e3f9 cellSpacing=0 cellPadding=0 
                ...
                <TBODY> 
                <TR> 
                  <TD align="left"  bgColor=#eeeeee><b>&nbsp;FILTRO</b></TD>
                </TR>
                </TBODY> 
              </TABLE>
                  ...
                  <!-- Inicio Grilla -->
                           <asp:GridView ID="Grilla" runat="server" 
                            ...
                            <asp:TemplateField HeaderText="Acción"  >
                              <ItemTemplate>
                               <a href="#" onclick="javascript:validamodificacion('Juicio.aspx?Codigo=<%# Eval("id_cobranza") %>');" ><asp:Image ID="Image1" runat="server" ImageUrl="../../imagenes/b_editar.gif" ToolTip="Editar"  /></a> 
                              </ItemTemplate>
                             </asp:TemplateField>
