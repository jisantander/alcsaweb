<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MntEstadosReconstitucion.aspx.cs" Inherits="CobranzaALC.Cobranza.mantenedores.MntEstadosReconstitucion" %>
...
<script language="javascript" type="text/javascript">
    ...
    function ValidarGuardar() {
        ...
        if (confirm('Esta seguro de guardar el estado, recuerde que los estados no se pueden eliminar, ni editar ?')) {
            return true;
        } else return false;
    }
          ...
          <TR> 
            ...
            <!-- Zona de Titulo -->
              ...
              <TABLE borderColor=#c8e3f9 cellSpacing=0 cellPadding=0 
                ...
                <TBODY> 
                <TR> 
                  <TD align="left"  bgColor=#eeeeee><b>&nbsp;ESTADOS RECONSTITUCIONES</b></TD>
                </TR>
                </TBODY> 
              </TABLE>
              ...
              <td valign="top">
                  ...
                  <tr>
                          <td align="right" class="style4" >Estado&nbsp; :</td>
                        <td  align=left>
                            <asp:TextBox ID="txtEstadoReconstitucion" runat="server" 
