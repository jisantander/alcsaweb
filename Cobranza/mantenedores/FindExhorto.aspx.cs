...
{
    public partial class FindExhorto : System.Web.UI.Page
    {
        ...
        {
            this.Grilla.DataSource = ALC_FW20.ALCLOCAL.Consulta.ConsultaExhorto(this.txtRol.Text, this.txtRutDeudor.Text, this.txtNroOperacion.Text);
            this.Grilla.DataBind();
        }
    }
}