<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DdaBbvaCorrigida2014PagareSinExhorto.aspx.cs" Inherits="CobranzaALC.Cobranza.Demandas.Formatos.DdaBbvaCorrigida2014PagareSinExhorto" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <p style="text-align: justify;font-family: Verdana;">
                ...
                ,  suscrito por don (ña) <asp:Label ID="lblNombreDeudor1" runat="server" Font-Bold="True"></asp:Label>
                    &nbsp;en su calidad de suscriptor  y deudor principal, por la cantidad de $«MONTO_CAPITAL».- por concepto de capital, y $ «MONTO_INTERESES».-, por concepto de intereses, con fecha «FECHA_SUSCRIPCIÓN».
            </p>
            <p style="text-align: justify;font-family: Verdana;">
                ...
                &nbsp;% mensual</strong>, el cual se encuentra incorporado al valor final de cada una de las cuotas que a continuación se señalan. El pago, según describe el pagaré acompañado, se efectuaría en   
                ...
                &nbsp;primeras, y por $</strong><asp:Label ID="lblMontoUltimaCuota" runat="server" Font-Bold="True"></asp:Label>
            ...
            <p style="text-align: justify;font-family: Verdana;">
                <strong>RUEGO A US.</strong>, tener por entablada demanda ejecutiva y despachar mandamiento de ejecución y embargo en contra de don(ña)  <asp:Label ID="lblNombreDeudor2" runat="server" Font-Bold="True"></asp:Label>
