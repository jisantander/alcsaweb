<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DdaUfSinExhorto.aspx.cs" Inherits="CobranzaALC.Cobranza.Demandas.Formatos.DdaUfSinExhorto" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <p style="text-align: justify; font-family: Verdana;">
                Mi representado es dueño del siguiente pagaré suscrito por don (ña)  «NOMBRE_DEMANDADO»,  ignoro profesión u oficio, con  domicilio en   
            ...
            <p style="text-align: justify; font-family: Verdana;">
                ...
                &nbsp;% <strong>anual</strong>, el cual se encuentra incorporado al valor final de cada una de las cuotas que a continuación se señalan. El pago, según describe el pagaré acompañado, se efectuaría en<strong> </strong>  
            ...
            <p style="text-align: justify; font-family: Verdana;">
                Se estipula la cláusula sin obligación de protesto, pero si el tenedor optare por la realización de dicha diligencia, podrá hacerla. En todo caso, se estipuló que 
            </p>
            <p style="text-align: justify; font-family: Verdana;">
                en el evento de protesto el suscriptor se obliga a pagar los gastos e impuestos que devenguen.
            </p>
            <p style="text-align: justify; font-family: Verdana;">
            ...
            <p style="text-align: justify; font-family: Verdana;">
                <strong>RUEGO A US.</strong>, tener por entablada demanda ejecutiva y despachar mandamiento de ejecución y embargo en contra de don<strong>  </strong><asp:Label ID="lblNombreDeudor1" runat="server" Font-Bold="True"></asp:Label>
            ...
            <p style="text-align: justify; font-family: Verdana;">
                <strong>1.-</strong> Con citación, Pagaré B.B.V.A. numero «NUMERO_PAGARÉ».-
            </p>
            <p style="text-align: justify; font-family: Verdana;">
