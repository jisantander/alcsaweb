<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buscaCobranzaPrenda.aspx.cs" Inherits="CobranzaALC.Cobranza.Prendas.buscaCobranzaPrenda" %>
                  ...
                  <!-- Inicio Grilla -->
                           <asp:GridView ID="Grilla" runat="server" 
                            ...
                            <asp:TemplateField HeaderText="Acción"  >
                              <ItemTemplate>
                               <a href="#" onclick="javascript:Ir('Prenda.aspx?Codigo=<%# Eval("id_cobranza") %>','<%# Eval("tipo") %>');" ><asp:Image ID="Image1" runat="server" ImageUrl="~/images/b_editar.gif" ToolTip="Agregar gasto"  /></a> 
                              </ItemTemplate>
                             </asp:TemplateField>
