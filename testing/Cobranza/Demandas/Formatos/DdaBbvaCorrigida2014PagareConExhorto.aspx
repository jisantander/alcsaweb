<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DdaBbvaCorrigida2014PagareConExhorto.aspx.cs" Inherits="CobranzaALC.Cobranza.Demandas.Formatos.DdaBbvaCorrigida2014PagareConExhorto" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <p style="text-align: justify; font-family: Verdana;">
                Mi representado es dueño del siguiente pagaré suscrito por don (ña) 
                <asp:Label ID="lblNombreDeudor0" runat="server" Font-Bold="True"></asp:Label>
                ,  ignoro profesión u oficio, con domicilio en  
                <asp:Label ID="lblDomicilio0" runat="server" Font-Bold="True"></asp:Label>
                , comuna de «COMUNA_DOMICILIO» cuyos términos son los siguientes:
            </p>
            <p style="text-align: justify; font-family: Verdana;">
                Pagaré B.B.V.A. numero <asp:Label ID="lblNumeroPagare" runat="server" Font-Bold="True"></asp:Label>
                ,  suscrito por don (ña) 
                <asp:Label ID="lblNombreDeudor1" runat="server" Font-Bold="True"></asp:Label>
                &nbsp;en su calidad de suscriptor y deudor principal, por la cantidad de $«MONTO_CAPITAL».- por concepto de capital, y $ «MONTO_INTERESES».-, por concepto de intereses, con fecha 
                <asp:Label ID="lblFechaSuscripcion" runat="server" Font-Bold="True"></asp:Label>
                .
            </p>
            <p style="text-align: justify; font-family: Verdana;">
                Sobre el capital adeudado se devengaría un interés del 
                <asp:Label ID="lblTasaInteres" runat="server" Font-Bold="True"></asp:Label>
                <strong>&nbsp;% mensual</strong>, el cual se encuentra incorporado al valor final de cada una de las cuotas que a continuación se señalan. El pago, según describe el pagaré acompañado, se efectuaría en  
                <asp:Label ID="lblNumeroTotalCuotas" runat="server" Font-Bold="True"></asp:Label>
                &nbsp;cuotas sucesivas por un monto de <strong>$</strong><asp:Label ID="lblMontoCuotas" runat="server" Font-Bold="True"></asp:Label>
                .- <strong>las  
                <asp:Label ID="lblNumeroPrimerasCuotas" runat="server" Font-Bold="True"></asp:Label>
                &nbsp;primeras, y por $ </strong> 
                <asp:Label ID="lblMontoUltimaCuota" runat="server" Font-Bold="True"></asp:Label>
            ...
            <p style="text-align: justify; font-family: Verdana;">
                La firma del suscriptor se encuentra autorizada por notario público, por lo que el pagaré constituye titulo ejecutivo perfecto en su contra, siendo además, la obligación liquida, actualmente exigible y la acción ejecutiva no está prescrita.
            </p>
            <p style="text-align: justify; font-family: Verdana;">
                Se hace presente, que el deudor se encuentra en mora de la obligación a contar de la cuota Nº 
                <asp:Label ID="lblNumeroCuotaMora" runat="server" Font-Bold="True"></asp:Label>
                &nbsp;,con vencimiento de fecha
                <asp:Label ID="lblFechaMora" runat="server" Font-Bold="False"></asp:Label>
&nbsp;en adelante, incumplimiento que faculta al Banco para exigir de inmediato, y como si fuera de plazo vencido, la totalidad de la deuda, por lo que vengo en exigir el pago total y anticipado de la obligación del pagaré, mediante la notificación de la presente demanda.
            </p>
            <p style="text-align: justify; font-family: Verdana;">
                ...
                , y de conformidad a lo establecido en el artículo 30 de la Ley 18.010,  asciende a la cantidad $«MONTO_DEUDA_LIQUIDACIÓN».-, correspondiente a capital adeudado por concepto de cuotas vencidas y no vencidas. A la suma señalada se le debe adicionar los intereses convencionales y penales que se generen a contar desde la mora, hasta la fecha del pago efectivo de la deuda mas las costas del juicio.
            </p>
            <p style="text-align: center; font-family: Verdana;">
                <br />
            ...
            <p style="text-align: justify; font-family: Verdana;">
                <strong>RUEGO A US.</strong>, tener por entablada demanda ejecutiva y despachar mandamiento de ejecución y embargo en contra de don(ña)  
                <asp:Label ID="lblNombreDeudor2" runat="server" Font-Bold="True"></asp:Label>
                , ya individualizado, en su calidad de suscriptor y deudor principal del pagaré singularizado, por la suma de $«MONTO_DEUDA_LIQUIDACIÓN».- correspondiente a capital adeudado vencido y capital adeudado no vencido de conformidad a lo establecido en el artículo 30 de la Ley 18010; todo ello más los intereses correspondientes, que se generan a contar desde la mora y hasta la fecha del pago efectivo de la deuda, más las costas del juicio y disponer que se continúe la ejecución, acogiendo la demanda en todas sus partes, hasta que se haga a mi representado entero pago de sus acreencias, con costas.   
            </p>
            <p style="text-align: justify; font-family: Verdana;">
            ...
            <p style="text-align: justify; font-family: Verdana;">
                <strong>1.-</strong> Con citación, Pagaré B.B.V.A. numero  
                <asp:Label ID="lblNumeroPagare0" runat="server" Font-Bold="True"></asp:Label>
                .-
            </p>
            <p style="text-align: justify; font-family: Verdana;">
            ...
            <p style="text-align: justify; font-family: Verdana;">
                <strong>TERCER OTROSI:</strong> Ruego a SS. tener presente para el solo efecto de determinar la cuantía del juicio, que el valor de lo demandado asciende a la suma de $«MONTO_DEUDA_LIQUIDACIÓN».-, correspondiente a capital adeudado vencido y capital adeudado no vencido, todo ello más los intereses correspondientes que se generan a contar desde la fecha de la mora, hasta la fecha del pago efectivo de la deuda, mas costas.
            </p>
            <p style="text-align: justify; font-family: Verdana;">
            ...
            <p style="text-align: justify; font-family: Verdana;">
                <strong>QUINTO OTROSI:</strong> Que, en razón que el ejecutado tiene su domicilio en la comuna de  
                <asp:Label ID="lblDomicilio" runat="server" Font-Bold="True"></asp:Label>
                , y con el objeto de notificar la demanda y requerirlo de pago,  vengo en solicitar se exhorte al Juzgado de Letras de turno  competente, de la comuna de 
                <asp:Label ID="lblNombreComunaExhorto" runat="server" Font-Bold="True"></asp:Label>
                . 
            </p>
            <p style="text-align: justify; font-family: Verdana;">
