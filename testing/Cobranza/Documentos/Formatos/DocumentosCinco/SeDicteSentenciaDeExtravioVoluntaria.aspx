<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeDicteSentenciaDeExtravioVoluntaria.aspx.cs" Inherits="CobranzaALC.Cobranza.Documentos.Formatos.DocumentosCinco.SeDicteSentenciaDeExtravioVoluntaria" %>
    ...
    <form id="form1" runat="server">
        <div>
            <p style="text-align: left; font-family: Verdana;">
                SE DICTE SENTENCIA DE EXTRAVIO.- 
            </p>
            <br />
            <br />
            ...
            <br />
            <p style="text-align: justify; font-family: Verdana;">
                <strong>RUEGO A US.</strong>  acceder a lo solicitado dictando la sentencia de extravío del título ya citado.-
            </p>
        </div>
    </form>
</body>
