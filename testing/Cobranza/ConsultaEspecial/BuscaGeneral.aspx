<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuscaGeneral.aspx.cs" Inherits="CobranzaALC.Cobranza.ConsultaEspecial.BuscaGeneral" %>
                  ...
                  <!-- Inicio Grilla -->
                           <asp:GridView ID="Grilla" runat="server" 
                            ...
                            <asp:TemplateField HeaderText="Acción"  >
                              <ItemTemplate>
                               <a href="#" onclick="javascript:Ir('/cobranza/procesos/MostrarfonosDeudor.aspx?Codigo=<%# Eval("id_cobranza") %>&rutdeudor=<%# Eval("rut_deudor") %>&id_juicios=<%# Eval("id_juicios") %>&estado=<%# Eval("Nrooperacion") %>','<%# Eval("estado") %>');" ><asp:Image ID="Image1" runat="server" ImageUrl="~/images/b_editar.gif" ToolTip="Agregar Juicio"  /></a> 
                              </ItemTemplate>
                             </asp:TemplateField>
