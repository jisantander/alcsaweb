<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuscaPrejudicial.aspx.cs" Inherits="CobranzaALC.Cobranza.ConsultaEspecial.BuscaPrejudicial" %>
                  ...
                  <!-- Inicio Grilla -->
                           <asp:GridView ID="Grilla" runat="server" 
                            ...
                            <asp:TemplateField HeaderText="Acción"  >
                              <ItemTemplate>
                               <a href="#" onclick="javascript:Ir('ConsultaPrejudicial.aspx?Codigo=<%# Eval("id_cobranza") %>','<%# Eval("estado") %>');" ><asp:Image ID="Image1" runat="server" ImageUrl="~/images/b_editar.gif" ToolTip="Agregar Documento Pre-Judicial"  /></a> 
                              </ItemTemplate>
                             </asp:TemplateField>
