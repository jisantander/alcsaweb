...
{
    public partial class ReporteConsultaGeneralBieneRaices : System.Web.UI.Page
    {
        private void Excel()
        {
            ...
            base.Response.AddHeader("Content-Disposition", "attachment;filename=ReporteBienesRaices_" + DateTime.Now.ToString("ddMMyyyy_HHmmss") + ".xls");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!this.Page.IsPostBack)
                {
                    ...
                    table = (DataTable)this.Session["ReporteExcelConsultaGeneralBieneRaices"];
