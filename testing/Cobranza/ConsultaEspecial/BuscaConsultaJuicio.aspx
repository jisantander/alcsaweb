<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuscaConsultaJuicio.aspx.cs" Inherits="CobranzaALC.Cobranza.ConsultaEspecial.BuscaConsultaJuicio" %>
...
<script language="javascript" type="text/javascript">
    ...
    function ImprimirInforme(cobranza) {

        url = 'ReporteJuicioGeneral.aspx?codigo=' + cobranza;
                  ...
                  <!-- Inicio Grilla -->
                           <asp:GridView ID="Grilla" runat="server" 
                            ...
                            <asp:TemplateField HeaderText="Acción"  >
                              <ItemTemplate>
                               <a href="#" onclick="javascript:ImprimirInforme('<%# Eval("id_cobranza") %>');" ><asp:Image ID="Image1" runat="server" ImageUrl="~/images/b_editar.gif" ToolTip="Agregar Juicio"  /></a> 
                              </ItemTemplate>
                             </asp:TemplateField>
