namespace CobranzaALC.Cobranza.ConsultaEspecial
{
    ...
    public partial class jui_EtapaExcel : Page
    {
        private void Excel()
        {
            ...
            base.Response.AddHeader("Content-Disposition", "attachment;filename=EtapaJuicio.xls");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.Page.IsPostBack)
            {
                ...
                table = (DataTable) this.Session["Excel_jui_etapa"];
