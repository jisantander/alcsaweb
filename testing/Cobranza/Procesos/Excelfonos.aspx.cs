namespace CobranzaALC.Cobranza.Procesos
{
    ...
    public partial class Excelfonos : Page
    {
        ...
        private void Excel()
        {
            ...
            base.Response.AddHeader("Content-Disposition", "attachment;filename=ExcelTelefonos.xls");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.Page.IsPostBack)
            {
                ...
                table = (DataTable) this.Session["Excel_fo_nos"];
