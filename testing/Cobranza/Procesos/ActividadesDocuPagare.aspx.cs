namespace CobranzaALC.Cobranza.Procesos
{
    ...
    public partial class ActividadesDocuPagare : Page
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string str5 = "ActividadesDocuPagare.aspx?Codigo=" + this.hiddidjuicio.Value.ToString() + "&idCobranza=" + this.hiddidCobranza.Value.ToString() + "&termino=" + str4;
        ...
        private void ComboSubTramite()
        {
            ...
            this.subtramite.DataSource = Consulta.ComboSubTramiteGENERAL("DOCUPAGARE");
        ...
        {
            DataTable table = null;
            table = Consulta.GENMostrartramiteProximaGestion(indice, "DOCUPAGARE");
            try
            {
        ...
        {
            DataTable table = null;
            table = Consulta.GENtramite("DOCUPAGARE");
