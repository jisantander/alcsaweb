namespace CobranzaALC.Cobranza.Procesos
{
    ...
    public partial class ActividadesDocuEstandard2 : Page
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string str5 = "ActividadesDocuEstandard2.aspx?Codigo=" + this.hiddidjuicio.Value.ToString() + "&idCobranza=" + this.hiddidCobranza.Value.ToString() + "&termino=" + str4;
        ...
        {
            DataTable table = null;
            table = Consulta.GENMostrartramiteProximaGestion(indice, "ESTANDARD2");
            try
            {
        ...
        {
            DataTable table = null;
            table = Consulta.GENtramite("ESTANDARD2");
