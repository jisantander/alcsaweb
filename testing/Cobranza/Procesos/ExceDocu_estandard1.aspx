<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExceDocu_estandard1.aspx.cs" Inherits="CobranzaALC.Cobranza.Procesos.ExceDocu_estandard1" %>
...
<body>
    ...
    <asp:GridView ID="Grilla" runat="server" 
           ...
           <asp:TemplateField HeaderText="Relación de Hechos">
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblCweweweweodigo" runat="server" Text='<%# Bind("relacion_hechos") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
           ...
           <asp:TemplateField HeaderText="Petitorio">
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblwewewrrr44Codigo" runat="server" Text='<%# Bind("petitorio") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Documentos Fundantes">
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lbl333Codigo" runat="server" Text='<%# Bind("doc_fundantes") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
