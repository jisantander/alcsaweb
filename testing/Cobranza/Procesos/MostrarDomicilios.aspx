<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MostrarDomicilios.aspx.cs" Inherits="CobranzaALC.Cobranza.Procesos.MostrarDomicilios" %>
...
<script language="javascript" type="text/javascript">
    ...
    function Cerrar() {
        window.location = '../ConsultaEspecial/BuscaGeneral2.aspx';
        return false;
    }
          ...
          <TR> 
            ...
            <!-- Zona de Titulo -->
              ...
              <TABLE borderColor=#c8e3f9 cellSpacing=0 cellPadding=0 
                ...
                <TBODY> 
                <TR> 
                  <TD align="left"  bgColor=#eeeeee><b>&nbsp;DOMICILIOS</b></TD>
                </TR>
                </TBODY> 
              </TABLE>
                            ...
                            <asp:TemplateField HeaderText="Block" HeaderStyle-HorizontalAlign="Left">
                             ...
                             <asp:TemplateField HeaderText="Región" HeaderStyle-HorizontalAlign="Left">
                               ...
                               <asp:TemplateField HeaderText="Comuna" HeaderStyle-HorizontalAlign="Left">
                                ...
                                <asp:BoundField DataField="SinNuevosDomicilios" HeaderText="Nuevos Domicilios Encontrados" />
