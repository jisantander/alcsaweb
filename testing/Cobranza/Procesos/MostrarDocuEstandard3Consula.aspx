<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MostrarDocuEstandard3Consula.aspx.cs" Inherits="CobranzaALC.Cobranza.Procesos.MostrarDocuEstandard3Consula" %>
        ...
        <TABLE width=633 align=center border=0  >
          ...
          <TR> 
                           ...
                           <asp:GridView ID="Grilla" runat="server" 
                            ...
                            <Columns>
                              ...
                              <asp:TemplateField HeaderText="Cuantia">
                                ...
                                <ItemTemplate>
                                <asp:Label ID="lblwew33eCodiwewego" runat="server" Text='<%# Bind("cuantia") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
           ...
           <asp:TemplateField HeaderText="Monto Remuneración">
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblCwew444eweweodigo" runat="server" Text='<%# Bind("txtMontoRemuneracion") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
           ...
           <asp:TemplateField HeaderText="Cargo">
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblwe5552wewrrr44Codigo" runat="server" Text='<%# Bind("txtCargo") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Relación Hechos">
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lbl333453Codigo" runat="server" Text='<%# Bind("Relacion_Hechos") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblCod434663igo" runat="server" Text='<%# Bind("petitorio") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblCod4377743igo" runat="server" Text='<%# Bind("doc_fundantes") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblCo3434d4343igo" runat="server" Text='<%# Bind("observacion") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
