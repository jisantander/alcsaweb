<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MostrarDocuEstandard4Consula.aspx.cs" Inherits="CobranzaALC.Cobranza.Procesos.MostrarDocuEstandard4Consula" %>
          ...
          <TR> 
            ...
            <!-- Zona de Titulo -->
              ...
              <TABLE borderColor=#c8e3f9 cellSpacing=0 cellPadding=0 
                ...
                <TBODY> 
                <TR> 
                  <TD align="left"  bgColor=#eeeeee><b>&nbsp;<asp:Label  Text="DOCUMENTO EN COBRANZA" 
                           ...
                           <asp:GridView ID="Grilla" runat="server" 
                            ...
                            <Columns>
                              ...
                              <asp:TemplateField HeaderText="Cuantia">
                                ...
                                <ItemTemplate>
                                <asp:Label ID="lblwew44eCodiwewego" runat="server" Text='<%# Bind("cuantia") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
                      
           
           <asp:TemplateField HeaderText="Delito">
                                <HeaderStyle Wrap="true"></HeaderStyle>
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblCwewew353535eweodigo" runat="server" Text='<%# Bind("delito") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
                      
                      
                         
           <asp:TemplateField HeaderText="Situación Autor">
                                <HeaderStyle Wrap="true"></HeaderStyle>
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblwewewrrr44Codigo" runat="server" Text='<%# Bind("situacion_autor") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Relación Hechos">
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lbl333565Codigo" runat="server" Text='<%# Bind("Relacion_Hechos") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblCod5656564343igo" runat="server" Text='<%# Bind("petitorio") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblCod56564343igo" runat="server" Text='<%# Bind("doc_fundantes") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblCod45556666343igo" runat="server" Text='<%# Bind("observacion") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
