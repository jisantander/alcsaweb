namespace CobranzaALC.Cobranza.Procesos
{
    ...
    public partial class ActividadesDocuJuicio : Page
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string str5 = "ActividadesDocuJuicio.aspx?Codigo=" + this.hiddidjuicio.Value.ToString() + "&idCobranza=" + this.hiddidCobranza.Value.ToString() + "&termino=" + str4;
        ...
        private void ComboSubTramite()
        {
            ...
            this.subtramite.DataSource = Consulta.ComboSubTramiteGENERAL("DOCUJUICIO");
        ...
        {
            DataTable table = null;
            table = Consulta.GENMostrartramiteProximaGestion(indice, "DOCUJUICIO");
            try
            {
        ...
        {
            DataTable table = null;
            table = Consulta.GENtramite("DOCUJUICIO");
