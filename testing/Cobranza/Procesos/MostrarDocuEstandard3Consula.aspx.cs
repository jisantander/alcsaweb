namespace CobranzaALC.Cobranza.Procesos
{
    ...
    public partial class MostrarDocuEstandard3Consula : Page
    {
        ...
        private void CargaGrilla(string idcobranza)
        {
            ...
            table = ConsultasEspecificas.MostrarDocuJuicioEstandard_3(idcobranza);
            this.Session["docu_juicio_estandard_3"] = table;
