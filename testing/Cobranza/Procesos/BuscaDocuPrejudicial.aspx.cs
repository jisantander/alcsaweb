namespace CobranzaALC.Cobranza.Procesos
{
    ...
    public partial class BuscaDocuPrejudicial : Page
    {
        ...
        {
            this.Grilla.DataSource = ConsultasEspecificas.ConsultaDocuPrejudicial(this.txtRut.Text, this.txtNroOperacion.Text);
