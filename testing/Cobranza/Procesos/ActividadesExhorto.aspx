<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActividadesExhorto.aspx.cs" Inherits="CobranzaALC.Cobranza.Procesos.ActividadesExhorto" %>
...
<script language="javascript" type="text/javascript">
    ...
    function Actividades() {
        ...
        valor = document.all("hiddidExhorto").value;
        url = 'MostrarActividadesExhorto.aspx?Codigo=' + valor;
    ...
    function ValidarGuardar() {
        ...
        if (trim(document.all("txtFechatramite").value) == "") {
            alert('Debe ingresar fecha de trámite de exhorto');
            document.all("txtFechatramite").focus();
            return false;
        }


        var mensaje = 'Esta seguro de guardar la actividad del exhorto ?';
          ...
          <TR> 
            ...
            <!-- Zona de Titulo -->
              ...
              <TABLE borderColor=#c8e3f9 cellSpacing=0 cellPadding=0 
                ...
                <TBODY> 
                <TR> 
                  <TD align="left"  bgColor=#eeeeee><b>&nbsp;INGRESO ACTIVIDADES EXHORTO</b></TD>
                </TR>
                </TBODY> 
              </TABLE>
              ...
              <td valign="top">
                  ...
                  <table border="0" bgColor=#e6ecf2 border=0 style="width: 735px">
                    ...
                    <tr>
                        ...
                        <td align="right" class="style3" >Tribunal Exhorto :</td>
                        <td  align=left style="margin-left: 40px">
                            <asp:TextBox ID="txtTribunalExhorto" runat="server" 
                                style="WIDTH: 250px; margin-left: 0px;" ReadOnly="True"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr>
                     ...
                     <tr>
                        <td align="right" class="style2" >Rol-Rit Juicio :</td>
                        <td  align=left class="style4">
                            <asp:TextBox ID="txtRoljuicio" runat="server" 
                                style="WIDTH: 150px; margin-left: 0px;" ReadOnly="True"></asp:TextBox>
                        </td>
                         <td align="right" class="style3" >Tribunal Juicio :</td>
                        <td  align="left" >
                             <asp:TextBox ID="txtTribunaljuicio" runat="server" 
                                style="WIDTH: 250px; margin-left: 0px;" ReadOnly="True"></asp:TextBox>
                        </td>
                    </tr>
                    
                    <tr>
                        <td align="right" class="style2" >Tipo Exhorto :</td>
                        <td  align=left class="style4">
                            <asp:TextBox ID="txtTipoExhorto" runat="server" 
                                style="WIDTH: 200px; margin-left: 0px;" ReadOnly="True"></asp:TextBox>
                        </td>
                         <td align="right" class="style3" >Receptor :</td>
                        <td  align="left" >
