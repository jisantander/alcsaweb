<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MostrarDocuEstandard1Consula.aspx.cs" Inherits="CobranzaALC.Cobranza.Procesos.MostrarDocuEstandard1Consula" %>
        ...
        <TABLE width=633 align=center border=0  >
          ...
          <TR> 
                           ...
                           <asp:GridView ID="Grilla" runat="server" 
                            ...
                            <Columns>
                              ...
                              <asp:TemplateField HeaderText="Cuantía">
                                ...
                                <ItemTemplate>
                                <asp:Label ID="lblweweC33EEodiwewego" runat="server" Text='<%# Bind("cuantia") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
                      
           
           <asp:TemplateField HeaderText="Relación de Hechos">
                                <HeaderStyle Wrap="true"></HeaderStyle>
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblCwewe343weweodigo" runat="server" Text='<%# Bind("relacion_hechos") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
           ...
           <asp:TemplateField HeaderText="Petitorio">
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblwrr44Codigo" runat="server" Text='<%# Bind("petitorio") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Documentos Fundantes">
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lbl33ERR3Codigo" runat="server" Text='<%# Bind("doc_fundantes") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblCod434E443igo" runat="server" Text='<%# Bind("observacion") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
