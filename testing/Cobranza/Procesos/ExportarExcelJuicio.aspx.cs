namespace CobranzaALC.Cobranza.Procesos
{
    ...
    public partial class ExportarExcelJuicio : Page
    {
        ...
        private void Excel()
        {
            ...
            base.Response.AddHeader("Content-Disposition", "attachment;filename=ExcelJuicios");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.Page.IsPostBack)
            {
                ...
                table = Consulta.BitacorasJuiciosExcel();
