<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocEstandard_1.aspx.cs" Inherits="CobranzaALC.Cobranza.Procesos.DocEstandard_1" %>
        ...
        <div id="divCuerpo">
            <table cellspacing="0" cellpadding="0" border="0" style="width: 100%;">
                <tbody>
                    ...
                    <tr>
                        <td class="barra-sub-titulo" colspan="4">DOCUMENTO ESTÁNDARD 1
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 30%" class="letra">
                            <asp:TextBox ID="txtDomicilioDeudor2" runat="server" Width="95%" CssClass="solo-lectura"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 30%" class="letra">
                            <asp:TextBox ID="txtcuantia" runat="server" Width="50%"></asp:TextBox>
                        </td>
                        <td style="width: 20%" class="letra">&nbsp;</td>
                        <td style="width: 30%" class="letra">&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="4">&nbsp;<asp:HiddenField ID="hdfIdDocumento1" runat="server" Value="0" />
