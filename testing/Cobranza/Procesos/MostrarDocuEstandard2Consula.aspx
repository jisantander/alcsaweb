<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MostrarDocuEstandard2Consula.aspx.cs" Inherits="CobranzaALC.Cobranza.Procesos.MostrarDocuEstandard2Consula" %>
        ...
        <TABLE width=633 align=center border=0  >
          ...
          <TR> 
                  ...
                  <!-- Inicio Grilla -->
                           <asp:GridView ID="Grilla" runat="server" 
                            ...
                            <Columns>
                              ...
                              <asp:TemplateField HeaderText="Juzgado">
                                <HeaderStyle Wrap="true"></HeaderStyle>
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblweweCo34342diwewego" runat="server" Text='<%# Bind("txtJuzgado") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
           ...
           <asp:TemplateField HeaderText="Rol">
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblCwewew3434eweodigo" runat="server" Text='<%# Bind("txtRol") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
           ...
           <asp:TemplateField HeaderText="Materia">
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblwewe33wrrr44Codigo" runat="server" Text='<%# Bind("txtMateria") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
                             
           
            <asp:TemplateField HeaderText="Monto Demandado">
                                <HeaderStyle Wrap="true"></HeaderStyle>
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lbl3WEWE33Codigo" runat="server" Text='<%# Bind("txtMontoDemandado") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
                                ...
                                <ItemStyle Wrap="false" ></ItemStyle>
                                <ItemTemplate>
                                <asp:Label ID="lblCod4EE343igo" runat="server" Text='<%# Bind("txtobservacion") %>' SortExpression = "Codigo" SortDirection="ASC"></asp:Label>
                              </ItemTemplate>
                             </asp:TemplateField>
