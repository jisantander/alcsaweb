<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Actividades.aspx.cs" Inherits="CobranzaALC.Cobranza.Procesos.Actividades" %>
...
<script language="javascript" type="text/javascript">
    ...
    function Actividades() {
        ...
        url = 'MostrarActividades.aspx?Codigo=' + valor;
    ...
    function ValidarGuardar() {
        ...
        if (document.all("hiddtramite").value == "T") {
            alert('Cobranza se encuentra términada y sus respectivas actividades');
            return false;
        }



        if (document.all("txtFechatramite").value == "") {
        ...
        if (document.all("subtramite").value == "28" || document.all("subtramite").value == "21" || document.all("subtramite").value == "22" || document.all("subtramite").value == "29") {
  ...
  <TR> 
    <TD height="394" valign="top" class=textos><BR>
      ...
      <FORM runat="server" id="Formulario"   >
        ...
        <TABLE align=center border=0 style="width: 721px"  >
          <TBODY> 
          <TR> 
                      <!---->          
            ...
            <!-- Zona de Titulo -->
              ...
              <td valign="top">
                  ...
                  <table border="0" bgColor=#e6ecf2 border=0 style="width: 722px">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td  align="left" class="style4" >
                            <asp:DropDownList ID="tramite" runat="server" 
                                ...
                                onselectedindexchanged="tramite_SelectedIndexChanged" >
                            </asp:DropDownList>
                        </td>
                        <td align="right" class="style3" >Próxima Gestión:</td>
                        <td  align=left>
                             <asp:DropDownList ID="proximagestion" runat="server" 
                                 style="WIDTH: 250px; margin-left: 0px;" Enabled="False" >
                            </asp:DropDownList>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td  align="left" class="style4" >
                           <asp:DropDownList ID="subtramite" runat="server" style="WIDTH: 200px; margin-left: 0px;" >
                            </asp:DropDownList>
                        </td>
                        <td align="right" class="style3" >Fec. Sub Trámite:</td>
                        <td  align=left>
                           <asp:TextBox ID="txtFechaSubTramite" runat="server" 
                                style="WIDTH: 100px; margin-left: 0px;"></asp:TextBox>
                        </td>
                    </tr>
