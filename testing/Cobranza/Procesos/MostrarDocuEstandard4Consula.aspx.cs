namespace CobranzaALC.Cobranza.Procesos
{
    ...
    public partial class MostrarDocuEstandard4Consula : Page
    {
        ...
        private void CargaGrilla(string idcobranza)
        {
            ...
            table = ConsultasEspecificas.MostrarDocuJuicioEstandard_4(idcobranza);
            this.Session["docu_juicio_estandard_4"] = table;
