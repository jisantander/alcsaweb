<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuscaCobranzaLiquidacion.aspx.cs" Inherits="CobranzaALC.Cobranza.CalculoLiquidacion.BuscaCobranzaLiquidacion" %>
                  ...
                  <!-- Inicio Grilla -->
                           <asp:GridView ID="Grilla" runat="server" 
                            ...
                            <asp:TemplateField HeaderText="Acción"  >
                              <ItemTemplate>
                               <a href="#" onclick="javascript:Ir('CalculoLiquidacion.aspx?Codigo=<%# Eval("id_cobranza") %>','<%# Eval("tipo") %>');" ><asp:Image ID="Image1" runat="server" ImageUrl="~/images/b_editar.gif" ToolTip="Agregar calculo liquidación"  /></a> 
                              </ItemTemplate>
                             </asp:TemplateField>
