<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mantenedor.aspx.cs" Inherits="CobranzaALC.Cobranza.mantenedores.Riesgo.Mantenedor" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table cellpadding="0" cellspacing="0" style="width: 700px;">
                ...
                <tr>
                    <td style="width: 25%">Id Riesgo</td>
                    <td style="width: 75%">
                        <asp:Label ID="lblIdRiesgo" runat="server" Text="0"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="width: 25%">Nombre</td>
                    <td style="width: 75%">
                        <asp:TextBox ID="txtNombreRiesgo" runat="server" Width="80%"></asp:TextBox>
                    </td>
                </tr>
                <tr>
