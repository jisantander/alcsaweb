<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Agregar.aspx.cs" Inherits="CobranzaALC.Cobranza.mantenedores.MarcaModelos.Agregar" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table cellpadding="0" cellspacing="0" style="width: 700px;">
                <tr>
                    <td class="barra-titulo" colspan="2">Agregar&nbsp; Modelo</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="auto-style2">
                        <asp:DropDownList ID="Lis_marca" runat="server"  AutoPostBack="true"  style="margin-left: 0px;" Width="512px">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td style="width: 25%"><strong>Modelo</strong></td>
                    <td style="width: 75%">
                        <asp:TextBox ID="Text_Modelo" runat="server" Width="512px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
