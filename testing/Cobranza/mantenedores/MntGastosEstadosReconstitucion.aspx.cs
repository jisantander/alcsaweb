namespace CobranzaALC.Cobranza.mantenedores
{
    ...
    public partial class MntGastosEstadosReconstitucion : Page
    {
        ...
        {
            Transaccion.InsertaTipoGastoReconst(this.txtEstadoReconstitucion.Text.ToString());
            string str = "MntGastosEstadosReconstitucion.aspx";
        ...
        {
            DataTable table = Consulta.GrillaTipoEstadosReconsti();
