namespace CobranzaALC.Cobranza.Gastos
{
    ...
    public partial class BuscaCobranzaGastos : Page
    {
        ...
        {
            this.Grilla.DataSource = ConsultasEspecificas.ConsultaGastoGeneral(null, this.txtRut.Text, this.txtNroOperacion.Text);
