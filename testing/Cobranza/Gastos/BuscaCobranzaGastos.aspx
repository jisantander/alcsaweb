<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuscaCobranzaGastos.aspx.cs" Inherits="CobranzaALC.Cobranza.Gastos.BuscaCobranzaGastos" %>
                                                    ...
                                                    <asp:GridView ID="Grilla" runat="server"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Acción">
                                                                <ItemTemplate>
                                                                    <a href="#" onclick="javascript:Ir('Gastos.aspx?Codigo=<%# Eval("id_cobranza") %>','<%# Eval("tipo") %>');">
