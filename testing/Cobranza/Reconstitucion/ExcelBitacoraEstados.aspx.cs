namespace CobranzaALC.Cobranza.Reconstitucion
{
    ...
    public partial class ExcelBitacoraEstados : Page
    {
        ...
        private void Excel()
        {
            ...
            base.Response.AddHeader("Content-Disposition", "attachment;filename=tablero");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.Page.IsPostBack)
            {
                ...
                table = Consulta.BitacorasEstadosExcel();
