namespace CobranzaALC.Cobranza.Reconstitucion
{
    ...
    public partial class BitacoraEstadosExcel : Page
    {
        ...
        private void Excel()
        {
            ...
            base.Response.AddHeader("Content-Disposition", "attachment;filename=Bitacora_" + DateTime.Now.ToString("ddMMyyyy_HHmmss") + ".xls");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.Page.IsPostBack)
            {
                ...
                table = (DataTable) this.Session["ExcelBitacoraEstados"];
