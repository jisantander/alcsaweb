<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComprobanteAbono.aspx.cs" Inherits="CobranzaALC.Cobranza.Abonos.ComprobanteAbono" %>
        ...
        <div>
                                ...
                                <td width="669" height="26" valign="top">
                                    <div xalign="center">
                                        <b>
                                            ...
                                            &nbsp;&nbsp;<b>COMPROBANTE DE INGRESO A CAJA</b>

                                            &nbsp;&nbsp&nbsp Nº
                                            <asp:Label ID="nroabono" runat="server"></asp:Label>
                    ...
                    <td valign="top" height="253">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td bgcolor="#FFFFCC" valign="top" colspan="2">&nbsp;<asp:Label ID="cliente" runat="server"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td height="23" valign="top" bgcolor="#CCCCCC"><b>&nbsp;Monto Pagado</b></td>
          ...
          <td valign="top" colspan="2" bgcolor="#FFFFCC">&nbsp;<asp:Label ID="nrocheque" runat="server" ></asp:Label></td>
                            ...
                            <tr>
                                ...
                                <td valign="top" colspan="2" bgcolor="#FFFFCC">&nbsp;<asp:Label ID="banco" runat="server"></asp:Label></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td width="193" valign="top">
                                    <div align="center">
                                        ...
                                        <br>
                                        <br>
                                        <font size="2"><u>Firma y Timbre Cajero</u></font>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td height="0"><font size="2">
                                    <asp:Label ID="usuario" runat="server"></asp:Label></font> </td>
                                <td></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td height="1"><font size="2">Hora :
                                    <asp:Label ID="hora" runat="server"></asp:Label></font></td>
                                <td width="284"></td>
                                <td></td>
                            </tr>
                        </table>
