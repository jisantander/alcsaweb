namespace CobranzaALC.Cobranza.Prendas
{
    ...
    public partial class buscaCobranzaPrenda : Page
    {
        ...
        {
            this.Grilla.DataSource = ConsultasEspecificas.ConsultaPrendaGeneral(null, this.txtRut.Text, this.txtNroOperacion.Text);
