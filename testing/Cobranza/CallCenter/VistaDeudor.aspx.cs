...
namespace CobranzaALC.Cobranza.CallCenter
{
    public partial class VistaDeudor : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // ----------------------------------------------------------------------------------------------------
            int intRut = 0;
            if (!int.TryParse(strRutDeudor, out intRut)) return;

            strRutDeudor = string.Format("{0}{1}", intRut, ALCSA.FWK.IdentificacionTributaria.CalcularDigitoVerificadorRut(intRut));
